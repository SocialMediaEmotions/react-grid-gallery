...
var Gallery = function (_Component) {
  ...
  _createClass(Gallery, [{
    ...
    key: 'onDragStart',
    value: function onDragStart(evt, idx, key) {
    ...
    key: 'onDragEnd',
    value: function onDragEnd(destination, source, draggedUniqueIdentifier, ownUniqueIdentifier) {
      var _this2 = this;

      if (destination === undefined || source === undefined || draggedUniqueIdentifier !== ownUniqueIdentifier) {
        return;
      }
      var reorderedImages = this.reorder(this.state.images, source, destination);
      this.setState({
        images: reorderedImages,
        thumbnails: this.renderThumbs(this._gallery.clientWidth, reorderedImages.images)
      }, function () {
        !_this2.props.onSwap || _this2.props.onSwap(source, destination);
      });
    }
  }, {
    key: 'renderThumbs',
        ...
        return _react2.default.createElement(
          'div',
          {
            ...
            onDrop: function onDrop(evt) {
              return _this3.onDragEnd(idx, evt.dataTransfer.getData("source"), evt.dataTransfer.getData("uniqueIdentifier"), _this3.uniqueId);
            },
            onDragOver: function onDragOver(evt) {
              return evt.preventDefault();
            },
            onDragStart: function onDragStart(evt) {
              return _this3.onDragStart(evt, idx, _this3.uniqueId);
            }
          },
          _react2.default.createElement(_Image2.default, {
            ...
            isSelectable: _this3.props.enableImageSelection,
            onClick: _this3.getOnClickThumbnailFn(),
            onSelectImage: _this3.onSelectImage,
            tagStyle: _this3.props.tagStyle,
            tileViewportStyle: _this3.props.tileViewportStyle,
            thumbnailStyle: _this3.props.thumbnailStyle
          })
        );
      });
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          ref: function ref(_ref) {
            return _this3._gallery = _ref;
          }
        },
        _react2.default.createElement('iframe', {
          style: resizeIframeStyles,
          ref: function ref(c) {
            return c && c.contentWindow && c.contentWindow.addEventListener('resize', _this3.onResize);
          }
        }),
        images,
...
Gallery.propTypes = {
  ...
  thumbsDraggable: _propTypes2.default.bool.isRequired
};
